 ...
 *
 * File descriptor : Events/RevocationRequestInfo.proto
 */
...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Events.RevocationRequestInfo
 */
class RevocationRequestInfo extends \Protobuf\AbstractMessage
{
    ...
    /**
     * InitiatorBoxId required string = 1
     *
     * @var string
     */
    ...
    public static function fromArray(array $values)
    {
        if ( ! isset($values['InitiatorBoxId'])) {
            throw new \InvalidArgumentException('Field "InitiatorBoxId" (tag 1) is required but has no value.');
        }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->InitiatorBoxId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\RevocationRequestInfo#InitiatorBoxId" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\RevocationRequestInfo) {
