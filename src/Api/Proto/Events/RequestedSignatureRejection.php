...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Events.RequestedSignatureRejection
 */
class RequestedSignatureRejection extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'RequestedSignatureRejection',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ParentEntityId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\RequestedSignatureRejection#ParentEntityId" (tag 1) is required but has no value.');
        }

        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\RequestedSignatureRejection#SignedContent" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\RequestedSignatureRejection) {
