...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Events.ServiceDetailsAttachment
 */
class ServiceDetailsAttachment extends \Protobuf\AbstractMessage
{
    ...
    /**
     * DocumentDate optional string = 7
     *
     * @var string
     */
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ServiceDetailsAttachment#SignedContent" (tag 1) is required but has no value.');
        }

        if ($this->FileName === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ServiceDetailsAttachment#FileName" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\ServiceDetailsAttachment) {
