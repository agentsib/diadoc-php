...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Events.ContractAttachment
 */
class ContractAttachment extends \Protobuf\AbstractMessage
{
    ...
    /**
     * ContractPrice optional string = 9
     *
     * @var string
     */
    ...
    /**
     * ContractType optional string = 10
     *
     * @var string
     */
    ...
    /**
     * CustomData repeated message = 12
     *
    ...
    /**
     * Check if 'ContractPrice' has a value
     *
     * @return bool
     */
    public function hasContractPrice()
    {
        return $this->ContractPrice !== null;
    }

    /**
     * Get 'ContractPrice' value
     *
     * @return string
     */
     ...
     * @param string $value
     */
    public function setContractPrice($value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setContractPrice($values['ContractPrice']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ContractAttachment#SignedContent" (tag 1) is required but has no value.');
        }

        if ($this->FileName === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ContractAttachment#FileName" (tag 2) is required but has no value.');
        }

        if ($this->DocumentDate === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ContractAttachment#DocumentDate" (tag 7) is required but has no value.');
        }

        if ($this->DocumentNumber === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ContractAttachment#DocumentNumber" (tag 8) is required but has no value.');
        }
        ...
        if ($this->ContractPrice !== null) {
            ...
            $writer->writeString($stream, $this->ContractPrice);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 9) {
                ...
                $this->ContractPrice = $reader->readString($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->ContractPrice !== null) {
            $size += 1;
            $size += $calculator->computeStringSize($this->ContractPrice);
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\ContractAttachment) {
        ...
        $this->ContractPrice = ($message->ContractPrice !== null) ? $message->ContractPrice : $this->ContractPrice;
