...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Events.ResolutionRequestCancellationAttachment
 */
class ResolutionRequestCancellationAttachment extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'ResolutionRequestCancellationAttachment',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->InitialResolutionRequestId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ResolutionRequestCancellationAttachment#InitialResolutionRequestId" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\ResolutionRequestCancellationAttachment) {
