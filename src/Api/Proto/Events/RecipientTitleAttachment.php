...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Events.RecipientTitleAttachment
 */
class RecipientTitleAttachment extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ParentEntityId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\RecipientTitleAttachment#ParentEntityId" (tag 1) is required but has no value.');
        }

        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\RecipientTitleAttachment#SignedContent" (tag 2) is required but has no value.');
        }

        if ($this->NeedReceipt === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\RecipientTitleAttachment#NeedReceipt" (tag 5) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\RecipientTitleAttachment) {
