...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Events.XmlDocumentAttachment
 */
class XmlDocumentAttachment extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\XmlDocumentAttachment#SignedContent" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\XmlDocumentAttachment) {
