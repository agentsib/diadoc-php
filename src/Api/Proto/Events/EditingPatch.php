...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Events.EditingPatch
 */
class EditingPatch extends \Protobuf\AbstractMessage
{
    ...
    public static function fromArray(array $values)
    {
        ...
        if ( ! isset($values['Content'])) {
            throw new \InvalidArgumentException('Field "Content" (tag 2) is required but has no value.');
        }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ParentEntityId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\EditingPatch#ParentEntityId" (tag 1) is required but has no value.');
        }

        if ($this->Content === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\EditingPatch#Content" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\EditingPatch) {
