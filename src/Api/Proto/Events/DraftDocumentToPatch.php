...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Events.DraftDocumentToPatch
 */
class DraftDocumentToPatch extends \Protobuf\AbstractMessage
{
    ...
    /**
     * ExtendedSigner repeated message = 4
     *
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\DraftDocumentToPatch#DocumentId" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\DraftDocumentToPatch) {
