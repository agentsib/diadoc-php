...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Events.ReceiptAttachment
 */
class ReceiptAttachment extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ParentEntityId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ReceiptAttachment#ParentEntityId" (tag 1) is required but has no value.');
        }

        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ReceiptAttachment#SignedContent" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\ReceiptAttachment) {
