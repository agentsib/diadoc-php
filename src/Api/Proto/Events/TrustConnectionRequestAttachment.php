...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Events.TrustConnectionRequestAttachment
 */
class TrustConnectionRequestAttachment extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'TrustConnectionRequestAttachment',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\TrustConnectionRequestAttachment#SignedContent" (tag 1) is required but has no value.');
        }

        if ($this->FileName === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\TrustConnectionRequestAttachment#FileName" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\TrustConnectionRequestAttachment) {
