...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Events.ResolutionRouteAssignmentInfo
 */
class ResolutionRouteAssignmentInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->RouteId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ResolutionRouteAssignmentInfo#RouteId" (tag 1) is required but has no value.');
        }

        if ($this->Author === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\ResolutionRouteAssignmentInfo#Author" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\ResolutionRouteAssignmentInfo) {
