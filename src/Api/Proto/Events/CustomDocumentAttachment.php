...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Events.CustomDocumentAttachment
 */
class CustomDocumentAttachment extends \Protobuf\AbstractMessage
{
    ...
    public static function fromArray(array $values)
    {
        ...
        if ( ! isset($values['Type'])) {
            throw new \InvalidArgumentException('Field "Type" (tag 12) is required but has no value.');
        }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\CustomDocumentAttachment#SignedContent" (tag 1) is required but has no value.');
        }

        if ($this->FileName === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\CustomDocumentAttachment#FileName" (tag 2) is required but has no value.');
        }

        if ($this->Type === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\CustomDocumentAttachment#Type" (tag 12) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\CustomDocumentAttachment) {
