...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Events.SupplementaryAgreementAttachment
 */
class SupplementaryAgreementAttachment extends \Protobuf\AbstractMessage
{
    ...
    /**
     * ContractNumber required string = 10
     *
     * @var string
     */
    ...
    /**
     * ContractDate required string = 11
     *
     * @var string
     */
    ...
    /**
     * ContractType optional string = 12
     *
     * @var string
     */
    ...
    public static function fromArray(array $values)
    {
        ...
        if ( ! isset($values['ContractNumber'])) {
            throw new \InvalidArgumentException('Field "ContractNumber" (tag 10) is required but has no value.');
        }

        if ( ! isset($values['ContractDate'])) {
            throw new \InvalidArgumentException('Field "ContractDate" (tag 11) is required but has no value.');
        }
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'SupplementaryAgreementAttachment',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->SignedContent === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\SupplementaryAgreementAttachment#SignedContent" (tag 1) is required but has no value.');
        }

        if ($this->FileName === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\SupplementaryAgreementAttachment#FileName" (tag 2) is required but has no value.');
        }

        if ($this->DocumentDate === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\SupplementaryAgreementAttachment#DocumentDate" (tag 7) is required but has no value.');
        }

        if ($this->DocumentNumber === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\SupplementaryAgreementAttachment#DocumentNumber" (tag 8) is required but has no value.');
        }

        if ($this->ContractNumber === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\SupplementaryAgreementAttachment#ContractNumber" (tag 10) is required but has no value.');
        }

        if ($this->ContractDate === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Events\\SupplementaryAgreementAttachment#ContractDate" (tag 11) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Events\SupplementaryAgreementAttachment) {
