...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Docflow.OutboundInvoiceDocflow
 */
class OutboundInvoiceDocflow extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Docflow\OutboundInvoiceDocflow) {
