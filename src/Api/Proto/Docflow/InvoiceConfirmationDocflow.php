...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Docflow.InvoiceConfirmationDocflow
 */
class InvoiceConfirmationDocflow extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setConfirmationAttachment(\AgentSIB\Diadoc\Api\Proto\Docflow\SignedAttachment $value = null)
    {
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Docflow\InvoiceConfirmationDocflow) {
