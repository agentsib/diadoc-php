...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Docflow.DocflowEvent
 */
class DocflowEvent extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setDocument(\AgentSIB\Diadoc\Api\Proto\Docflow\DocumentWithDocflow $value = null)
    {
        $this->Document = $value;
    }
     ...
     * @param \AgentSIB\Diadoc\Api\Proto\Docflow\DocumentWithDocflow $value
     */
    public function setPreviousDocumentState(\AgentSIB\Diadoc\Api\Proto\Docflow\DocumentWithDocflow $value = null)
    {
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Docflow\DocflowEvent) {
