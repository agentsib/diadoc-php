...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Docflow.SignedAttachment
 */
class SignedAttachment extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setAttachment(\AgentSIB\Diadoc\Api\Proto\Docflow\Attachment $value = null)
    {
     ...
     */
    public function setSignature(\AgentSIB\Diadoc\Api\Proto\Docflow\Signature $value = null)
    {
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Docflow\SignedAttachment) {
