...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Docflow.DocumentDateAndNumber
 */
class DocumentDateAndNumber extends \Protobuf\AbstractMessage
{
    ...
    /**
     * DocumentDate optional string = 1
     *
     * @var string
     */
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Docflow\DocumentDateAndNumber) {
