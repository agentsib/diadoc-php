...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Docflow.ContractDocumentInfo
 */
class ContractDocumentInfo extends \Protobuf\AbstractMessage
{
    ...
    /**
     * ContractPrice optional string = 1
     *
     * @var string
     */
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Docflow\ContractDocumentInfo) {
