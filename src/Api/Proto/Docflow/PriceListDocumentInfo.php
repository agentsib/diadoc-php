...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Docflow.PriceListDocumentInfo
 */
class PriceListDocumentInfo extends \Protobuf\AbstractMessage
{
    ...
    /**
     * PriceListEffectiveDate optional string = 1
     *
     * @var string
     */
    ...
    /**
     * ContractDocumentDateAndNumber optional message = 2
     *
    ...
    /**
     * Check if 'ContractDocumentDateAndNumber' has a value
     *
     * @return bool
     */
    public function hasContractDocumentDateAndNumber()
    {
        return $this->ContractDocumentDateAndNumber !== null;
    }

    /**
     * Get 'ContractDocumentDateAndNumber' value
     *
     ...
     */
    public function setContractDocumentDateAndNumber(\AgentSIB\Diadoc\Api\Proto\Docflow\DocumentDateAndNumber $value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        ...
        $values  = array_merge([
            ...
            'ContractDocumentDateAndNumber' => null
        ], $values);

        $message->setPriceListEffectiveDate($values['PriceListEffectiveDate']);
        $message->setContractDocumentDateAndNumber($values['ContractDocumentDateAndNumber']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ContractDocumentDateAndNumber !== null) {
            $writer->writeVarint($stream, 18);
            $writer->writeVarint($stream, $this->ContractDocumentDateAndNumber->serializedSize($sizeContext));
            $this->ContractDocumentDateAndNumber->writeTo($context);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->ContractDocumentDateAndNumber = $innerMessage;
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->ContractDocumentDateAndNumber !== null) {
            $innerSize = $this->ContractDocumentDateAndNumber->serializedSize($context);
    ...
    public function clear()
    {
        ...
        $this->ContractDocumentDateAndNumber = null;
    }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Docflow\PriceListDocumentInfo) {
        ...
        $this->ContractDocumentDateAndNumber = ($message->ContractDocumentDateAndNumber !== null) ? $message->ContractDocumentDateAndNumber : $this->ContractDocumentDateAndNumber;
    }
