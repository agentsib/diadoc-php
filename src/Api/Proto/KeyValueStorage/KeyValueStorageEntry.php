...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.KeyValueStorage.KeyValueStorageEntry
 */
class KeyValueStorageEntry extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Key === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\KeyValueStorage\\KeyValueStorageEntry#Key" (tag 1) is required but has no value.');
        }

        if ($this->Value === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\KeyValueStorage\\KeyValueStorageEntry#Value" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\KeyValueStorage\KeyValueStorageEntry) {
