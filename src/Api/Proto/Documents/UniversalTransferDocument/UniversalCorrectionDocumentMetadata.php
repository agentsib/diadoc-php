...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Documents.UniversalTransferDocument.UniversalCorrectionDocumentMetadata
 */
class UniversalCorrectionDocumentMetadata extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentStatus === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#DocumentStatus" (tag 1) is required but has no value.');
        }

        if ($this->TotalInc === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#TotalInc" (tag 2) is required but has no value.');
        }

        if ($this->TotalDec === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#TotalDec" (tag 3) is required but has no value.');
        }

        if ($this->VatInc === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#VatInc" (tag 4) is required but has no value.');
        }

        if ($this->VatDec === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#VatDec" (tag 5) is required but has no value.');
        }

        if ($this->DocumentFunction === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#DocumentFunction" (tag 7) is required but has no value.');
        }

        if ($this->Currency === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#Currency" (tag 8) is required but has no value.');
        }

        if ($this->ConfirmationDateTimeTicks === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#ConfirmationDateTimeTicks" (tag 9) is required but has no value.');
        }

        if ($this->InvoiceAmendmentFlags === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#InvoiceAmendmentFlags" (tag 10) is required but has no value.');
        }

        if ($this->OriginalInvoiceNumber === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#OriginalInvoiceNumber" (tag 11) is required but has no value.');
        }

        if ($this->OriginalInvoiceDate === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\UniversalTransferDocument\\UniversalCorrectionDocumentMetadata#OriginalInvoiceDate" (tag 12) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Documents\UniversalTransferDocument\UniversalCorrectionDocumentMetadata) {
