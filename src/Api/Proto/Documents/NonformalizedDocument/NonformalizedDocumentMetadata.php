...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Documents.NonformalizedDocument.NonformalizedDocumentMetadata
 */
class NonformalizedDocumentMetadata extends \Protobuf\AbstractMessage
{
    ...
    {
        $this->DocumentStatus = \AgentSIB\Diadoc\Api\Proto\Documents\NonformalizedDocument\NonformalizedDocumentStatus::UnknownNonformalizedDocumentStatus();
     ...
     *
     * @param \AgentSIB\Diadoc\Api\Proto\Documents\NonformalizedDocument\NonformalizedDocumentStatus $value
     */
    public function setDocumentStatus(\AgentSIB\Diadoc\Api\Proto\Documents\NonformalizedDocument\NonformalizedDocumentStatus $value = null)
    {
    ...
    public static function fromArray(array $values)
    {
        $message = new self();
        $values  = array_merge([
            'DocumentStatus' => \AgentSIB\Diadoc\Api\Proto\Documents\NonformalizedDocument\NonformalizedDocumentStatus::UnknownNonformalizedDocumentStatus(),
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.AgentSIB.Diadoc.Api.Proto.Documents.NonformalizedDocument.NonformalizedDocumentStatus',
                    'default_value' => \AgentSIB\Diadoc\Api\Proto\Documents\NonformalizedDocument\NonformalizedDocumentStatus::UnknownNonformalizedDocumentStatus()
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'ReceiptStatus',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->DocumentStatus = \AgentSIB\Diadoc\Api\Proto\Documents\NonformalizedDocument\NonformalizedDocumentStatus::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Documents\NonformalizedDocument\NonformalizedDocumentMetadata) {
