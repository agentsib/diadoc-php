...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Documents.AmendmentRequestMetadata
 */
class AmendmentRequestMetadata extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->AmendmentFlags === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\AmendmentRequestMetadata#AmendmentFlags" (tag 1) is required but has no value.');
        }

        if ($this->ReceiptStatus === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\AmendmentRequestMetadata#ReceiptStatus" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Documents\AmendmentRequestMetadata) {
