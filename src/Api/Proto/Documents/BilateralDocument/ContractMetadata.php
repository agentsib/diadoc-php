...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Documents.BilateralDocument.ContractMetadata
 */
class ContractMetadata extends \Protobuf\AbstractMessage
{
    ...
    /**
     * ContractPrice optional string = 2
     *
     * @var string
     */
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Documents\BilateralDocument\ContractMetadata) {
