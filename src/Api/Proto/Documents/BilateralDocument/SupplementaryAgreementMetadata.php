...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Documents.BilateralDocument.SupplementaryAgreementMetadata
 */
class SupplementaryAgreementMetadata extends \Protobuf\AbstractMessage
{
    ...
    /**
     * ContractType optional string = 3
     *
     * @var string
     */
    ...
    /**
     * ContractNumber required string = 4
     *
     * @var string
     */
    ...
    /**
     * ContractDate required string = 5
     *
     * @var string
     */
    ...
    public static function fromArray(array $values)
    {
        if ( ! isset($values['ContractNumber'])) {
            throw new \InvalidArgumentException('Field "ContractNumber" (tag 4) is required but has no value.');
        }

        if ( ! isset($values['ContractDate'])) {
            throw new \InvalidArgumentException('Field "ContractDate" (tag 5) is required but has no value.');
        }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ContractNumber === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\BilateralDocument\\SupplementaryAgreementMetadata#ContractNumber" (tag 4) is required but has no value.');
        }

        if ($this->ContractDate === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Documents\\BilateralDocument\\SupplementaryAgreementMetadata#ContractDate" (tag 5) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Documents\BilateralDocument\SupplementaryAgreementMetadata) {
