 ...
 *
 * File descriptor : ResolutionTarget.proto
 */
...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.ResolutionTarget
 */
class ResolutionTarget extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\ResolutionTarget) {
