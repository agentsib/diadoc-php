...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Departments.ParentDepartmentPatch
 */
class ParentDepartmentPatch extends \Protobuf\AbstractMessage
{
    ...
    /**
     * ParentDepartmentId required string = 1
     *
     * @var string
     */
    ...
    public static function fromArray(array $values)
    {
        if ( ! isset($values['ParentDepartmentId'])) {
            throw new \InvalidArgumentException('Field "ParentDepartmentId" (tag 1) is required but has no value.');
        }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ParentDepartmentId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Departments\\ParentDepartmentPatch#ParentDepartmentId" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Departments\ParentDepartmentPatch) {
