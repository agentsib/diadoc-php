...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Content
 */
class Content extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Size === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Content#Size" (tag 1) is required but has no value.');
        }

        if ($this->Size !== null) {
            $writer->writeVarint($stream, 13);
            $writer->writeSFixed32($stream, $this->Size);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->Size = $reader->readSFixed32($stream);
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Content) {
