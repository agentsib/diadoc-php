 ...
 *
 * File descriptor : RoamingNotification.proto
 */
...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.RoamingNotification
 */
class RoamingNotification extends \Protobuf\AbstractMessage
{
    ...
    public static function fromArray(array $values)
    {
        if ( ! isset($values['Success'])) {
            throw new \InvalidArgumentException('Field "Success" (tag 1) is required but has no value.');
        }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Success === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\RoamingNotification#Success" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\RoamingNotification) {
