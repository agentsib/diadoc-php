...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.StringValue
 */
class StringValue extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\StringValue) {
