 ...
 *
 * File descriptor : CustomDataItem.proto
 */
...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.CustomDataItem
 */
class CustomDataItem extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Key === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\CustomDataItem#Key" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\CustomDataItem) {
