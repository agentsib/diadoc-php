...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.AuthorizationPermission
 */
class AuthorizationPermission extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->IsBlocked === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\AuthorizationPermission#IsBlocked" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\AuthorizationPermission) {
