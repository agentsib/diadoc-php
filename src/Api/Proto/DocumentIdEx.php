...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.DocumentIdEx
 */
class DocumentIdEx extends \Protobuf\AbstractMessage
{
    ...
    public static function fromArray(array $values)
    {
        ...
        if ( ! isset($values['BoxId'])) {
            throw new \InvalidArgumentException('Field "BoxId" (tag 3) is required but has no value.');
        }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->MessageId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\DocumentIdEx#MessageId" (tag 1) is required but has no value.');
        }

        if ($this->EntityId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\DocumentIdEx#EntityId" (tag 2) is required but has no value.');
        }

        if ($this->BoxId === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\DocumentIdEx#BoxId" (tag 3) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\DocumentIdEx) {
