 ...
 *
 * File descriptor : LoginPassword.proto
 */
...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.LoginPassword
 */
class LoginPassword extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Login === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\LoginPassword#Login" (tag 1) is required but has no value.');
        }

        if ($this->Password === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\LoginPassword#Password" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\LoginPassword) {
