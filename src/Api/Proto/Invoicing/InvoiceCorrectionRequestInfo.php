 ...
 *
 * File descriptor : Invoicing/InvoiceCorrectionRequestInfo.proto
 */
...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Invoicing.InvoiceCorrectionRequestInfo
 */
class InvoiceCorrectionRequestInfo extends \Protobuf\AbstractMessage
{
    ...
    /**
     * ErrorMessage required string = 1
     *
     * @var string
     */
    ...
    {
        if ( ! isset($values['ErrorMessage'])) {
            throw new \InvalidArgumentException('Field "ErrorMessage" (tag 1) is required but has no value.');
        }

        if ( ! isset($values['Signer'])) {
            throw new \InvalidArgumentException('Field "Signer" (tag 2) is required but has no value.');
        }
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'InvoiceCorrectionRequestInfo',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->ErrorMessage === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Invoicing\\InvoiceCorrectionRequestInfo#ErrorMessage" (tag 1) is required but has no value.');
        }

        if ($this->Signer === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Invoicing\\InvoiceCorrectionRequestInfo#Signer" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Invoicing\InvoiceCorrectionRequestInfo) {
