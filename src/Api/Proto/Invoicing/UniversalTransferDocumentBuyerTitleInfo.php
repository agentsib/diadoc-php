...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Invoicing.UniversalTransferDocumentBuyerTitleInfo
 */
class UniversalTransferDocumentBuyerTitleInfo extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'UniversalTransferDocumentBuyerTitleInfo',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentCreator === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Invoicing\\UniversalTransferDocumentBuyerTitleInfo#DocumentCreator" (tag 1) is required but has no value.');
        }

        if ($this->OperationContent === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Invoicing\\UniversalTransferDocumentBuyerTitleInfo#OperationContent" (tag 4) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Invoicing\UniversalTransferDocumentBuyerTitleInfo) {
