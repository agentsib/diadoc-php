...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Invoicing.WorkItem
 */
class WorkItem extends \Protobuf\AbstractMessage
{
    ...
    /**
     * AdditionalInfo optional string = 10
     *
     * @var string
     */
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Invoicing\WorkItem) {
