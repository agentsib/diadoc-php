 ...
 *
 * File descriptor : Invoicing/SignatureRejectionInfo.proto
 */
...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.Invoicing.SignatureRejectionInfo
 */
class SignatureRejectionInfo extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->Signer === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Invoicing\\SignatureRejectionInfo#Signer" (tag 2) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Invoicing\SignatureRejectionInfo) {
