...
/**
 * Protobuf message : AgentSIB.Diadoc.Api.Proto.CloudSignFile
 */
class CloudSignFile extends \Protobuf\AbstractMessage
{
    ...
    /**
     * Content optional message = 1
     *
     * @var \AgentSIB\Diadoc\Api\Proto\Content_v2
     */
     ...
     * Get 'Content' value
     *
     * @return \AgentSIB\Diadoc\Api\Proto\Content_v2
     */
     ...
     */
    public function setContent(\AgentSIB\Diadoc\Api\Proto\Content_v2 $value = null)
    {
        $this->Content = $value;
    }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\CloudSignFile) {
