...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Registration.RegistrationConfirmRequest
 */
class RegistrationConfirmRequest extends \Protobuf\AbstractMessage
{
     ...
     * @param \Protobuf\Stream $value
     */
    public function setDataToSign($value)
    {
        if ($value !== null && ! $value instanceof \Protobuf\Stream) {
            $value = \Protobuf\Stream::wrap($value);
        }
    ...
    {
        if ( ! isset($values['DataToSign'])) {
            throw new \InvalidArgumentException('Field "DataToSign" (tag 3) is required but has no value.');
        }

        if ( ! isset($values['Signature'])) {
            throw new \InvalidArgumentException('Field "Signature" (tag 4) is required but has no value.');
        }
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'RegistrationConfirmRequest',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DataToSign === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Registration\\RegistrationConfirmRequest#DataToSign" (tag 3) is required but has no value.');
        }

        if ($this->Signature === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Registration\\RegistrationConfirmRequest#Signature" (tag 4) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Registration\RegistrationConfirmRequest) {
