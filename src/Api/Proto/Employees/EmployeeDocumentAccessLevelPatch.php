...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Employees.EmployeeDocumentAccessLevelPatch
 */
class EmployeeDocumentAccessLevelPatch extends \Protobuf\AbstractMessage
{
    ...
    /**
     * DocumentAccessLevel required enum = 1
     *
    ...
    {
        if ( ! isset($values['DocumentAccessLevel'])) {
            throw new \InvalidArgumentException('Field "DocumentAccessLevel" (tag 1) is required but has no value.');
        }
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'EmployeeDocumentAccessLevelPatch',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->DocumentAccessLevel === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Employees\\EmployeeDocumentAccessLevelPatch#DocumentAccessLevel" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Employees\EmployeeDocumentAccessLevelPatch) {
