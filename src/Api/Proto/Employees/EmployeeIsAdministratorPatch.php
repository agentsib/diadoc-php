...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Employees.EmployeeIsAdministratorPatch
 */
class EmployeeIsAdministratorPatch extends \Protobuf\AbstractMessage
{
    ...
    /**
     * IsAdministrator required bool = 1
     *
     * @var bool
     */
    ...
    public static function fromArray(array $values)
    {
        if ( ! isset($values['IsAdministrator'])) {
            throw new \InvalidArgumentException('Field "IsAdministrator" (tag 1) is required but has no value.');
        }
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'      => 'EmployeeIsAdministratorPatch',
            'field'     => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->IsAdministrator === null) {
            throw new \UnexpectedValueException('Field "\\AgentSIB\\Diadoc\\Api\\Proto\\Employees\\EmployeeIsAdministratorPatch#IsAdministrator" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Employees\EmployeeIsAdministratorPatch) {
